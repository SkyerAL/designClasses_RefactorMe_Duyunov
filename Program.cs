...
namespace MailSender
{
    ...
    /// <summary>
    /// Проведите рефакторинг, обеспечив лёгкое добавление правил валидации и изменения текста.
    /// Метод CheckBehaivior() должен выполняться без ошибок, соблюдая всё заданное поведение. 
    /// </summary>
